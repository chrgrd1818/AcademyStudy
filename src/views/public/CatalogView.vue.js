...
__VLS_asFunctionalElement(__VLS_intrinsicElements.h1, __VLS_intrinsicElements.h1)(__assign({ class: "text-3xl font-bold text-gray-900 mb-8" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "mb-8" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)(__assign({ value: (__VLS_ctx.searchQuery), type: "text", placeholder: "Search courses..." }, { class: "w-full max-w-md px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900" }));
if (__VLS_ctx.filteredCourses.length === 0) {
    ...
    for (var _i = 0, _a = __VLS_getVForSourceType((__VLS_ctx.filteredCourses)); _i < _a.length; _i++) {
        ...
        // @ts-ignore
        var __VLS_4 = __VLS_asFunctionalComponent(__VLS_3, new __VLS_3(__assign({ to: "/signup" }, { class: "inline-block px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition text-sm font-medium" })));
        var __VLS_5 = __VLS_4.apply(void 0, __spreadArray([__assign({ to: "/signup" }, { class: "inline-block px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition text-sm font-medium" })], __VLS_functionalComponentArgsRest(__VLS_4), false));
