    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, supabase_config_1.signIn)(email.value, password.value)];
            case 2:
                _a.sent();
                redirect = route.query.redirect || '/my-courses';
                router.push(redirect);
                return [3 /*break*/, 5];
            case 3:
                err_1 = _a.sent();
                error.value = err_1.message || 'Failed to sign in. Please check your credentials.';
                return [3 /*break*/, 5];
            case 4:
                loading.value = false;
                return [7 /*endfinally*/];
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.form, __VLS_intrinsicElements.form)(__assign({ onSubmit: (__VLS_ctx.handleLogin) }, { class: "space-y-6" }));
if (__VLS_ctx.error) {
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)(__assign(__assign({ id: "password", type: "password", required: true }, { class: "w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition text-gray-900" }), { placeholder: "••••••••" }));
(__VLS_ctx.password);
...
/** @type {[typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, ]} */ ;
// @ts-ignore
var __VLS_5 = __VLS_asFunctionalComponent(__VLS_4, new __VLS_4(__assign({ to: "/signup" }, { class: "text-blue-600 hover:text-blue-700 font-medium" })));
var __VLS_6 = __VLS_5.apply(void 0, __spreadArray([__assign({ to: "/signup" }, { class: "text-blue-600 hover:text-blue-700 font-medium" })], __VLS_functionalComponentArgsRest(__VLS_5), false));
